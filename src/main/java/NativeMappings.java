...
final class NativeMappings {
    ...
    @Structure.FieldOrder({"S_un"})
    public static class in_addr extends Structure {
        public in_addr_union S_un; // in_addr_t = uint32_t
    }

    @Structure.FieldOrder({"S_un_b", "S_un_w", "S_addr"})
    public static class in_addr_union extends Union {
        public in_addr_struct4 S_un_b;
        public in_addr_struct2 S_un_w;
        public Integer S_addr;
    }

    @Structure.FieldOrder({"s_b1", "s_b2", "s_b3", "s_b4"})
    public static class in_addr_struct4 extends Structure {
        public byte s_b1;
        public byte s_b2;
        public byte s_b3;
        public byte s_b4;
    ...
    @Structure.FieldOrder({"s_w1", "s_w2"})
    public static class in_addr_struct2 extends Structure {
        public short s_w1;
        public short s_w2;
    }
